...
import com.uqam.mentallys.databinding.FragmentAddEventHospitalizationBinding
...
@AndroidEntryPoint
class AddEventHospitalizationFragment : Fragment(R.layout.fragment_add_event_hospitalization) {
    private lateinit var binding: FragmentAddEventHospitalizationBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentAddEventHospitalizationBinding.bind(view)
        ...
        binding.apply {
            ...
            // Get Hospitalization name
            textEventHospitalizationPlace.doAfterTextChanged {
                viewModel.eventPlace = textEventHospitalizationPlace.text.toString()
            }
            ...
            viewModel.addEditEvent.collect { eventFromChannel ->
                when (eventFromChannel) {
                    is AddEditEventViewModel.AddEditPathwayEvent.NavigateToSavedEventScreen -> {
                        val action =
                            AddEventHospitalizationFragmentDirections.actionAddEventHospitalizationFragmentToSavedEventFragment()
