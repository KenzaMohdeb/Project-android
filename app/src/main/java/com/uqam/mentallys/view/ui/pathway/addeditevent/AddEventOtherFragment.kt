...
import com.uqam.mentallys.databinding.FragmentAddEventOtherBinding
...
@AndroidEntryPoint
class AddEventOtherFragment : Fragment(R.layout.fragment_add_event_other) {
    private lateinit var binding: FragmentAddEventOtherBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentAddEventOtherBinding.bind(view)
        ...
        binding.apply {
            ...
            // Get Nature of event
            textEventNature.doAfterTextChanged {
                viewModel.eventPlace = textEventNature.text.toString()
            }
            ...
            viewModel.addEditEvent.collect { eventFromChannel ->
                when (eventFromChannel) {
                    is AddEditEventViewModel.AddEditPathwayEvent.NavigateToSavedEventScreen -> {
                        val action =
                            AddEventOtherFragmentDirections.actionAddEventOtherFragmentToSavedEventFragment()
